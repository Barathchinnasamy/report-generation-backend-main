...
app.get("/usecase-report", async (_req: Request, res: Response) => {
  ...
  // pdfService.drawText("Usecase Prioritization Report - Lumbar ", {
  //   isBold: true,
  //   fontSize: 20,
  //   column: "left",
  //   color: rgb(0, 0.53, 0.71),
  // });
  // pdfService.drawText("Supply chain managers ", {
  //   isBold: true,
  //   fontSize: 20,
  //   column: "left",
  //   color: rgb(0, 0.53, 0.71),
  ...
  // pdfService.setCurrentY(10);
  // pdfService.drawText(`Report generated on - 07/07/2024`, {
  //   fontSize: 12,
  //   column: "left",
  // });
  ...
  // pdfService.setCurrentY(20);
  // pdfService.drawWrappedText(
  //   "2. Current and Target Values ............................................................................(1)",
  //   "left",
  //   6
  // );
  // pdfService.setCurrentY(20);
  // pdfService.drawWrappedText(
  //   "3. Total Cost of Ownership(TCO) .................................................................................(1)",
  //   "left",
  //   6
  // );
  // pdfService.setCurrentY(20);
  ...
  // pdfService.drawWrappedText(
  //   "5. Roadmap for Implementation.......................................(2)",
  //   "left",
  //   6
  // );
  // pdfService.setCurrentY(20);
  ...
  // pdfService.drawWrappedText(
  //   "• Initial Investment (Year 0): $300,000 (includes AI development, software licenses, hardware, and employee training).",
  //   "left",
  //   6
  // );
  // pdfService.drawWrappedText(
  //   "• Ongoing Annual Costs: $50,000 per year (starting from Year 1).",
  //   "left",
  //   6
  // );
  // pdfService.drawWrappedText("• Additional costs: Costs to handle any unexpected issues, maintain data integrity, and optimize performance.","left",6);

  pdfService.setCurrentY(20);

  pdfService.drawHeading("4. ROI Table", "left");
  // pdfService.setCurrentY(3);
  // pdfService.drawWrappedText("To calculate the ROI, we need to determine the net benefits of the automation system over time. The following factors should be considered:","left");
  // pdfService.setCurrentY(3);
  // pdfService.drawWrappedText(
  //   "• Break-even Point: Year 3, with an ROI of 0%.",
  //   "left",
  //   6
  // );
  // pdfService.drawWrappedText("• Year 4 ROI: Increases to 40%.", "left", 6);
  // pdfService.drawWrappedText(
  //   "• Year 5 ROI: Reaches approximately 81.8%.",
  //   "left",
  //   6
  // );
  const tableData = [
  ...
  pdfService.setCurrentY(10);
  // await pdfService.addLocalImage('')
  // pdfService.drawWrappedText("• Increased customer satisfaction and loyalty.","left",6);

  pdfService.setCurrentY(3);
  pdfService.drawHeading("5. Roadmap for Implementation", "left");
  // const roadmap = path.resolve();
  // const roadmapImg = await pdfDoc.embedPng(fs.readFileSync(roadmap));
  pdfService.setCurrentY(3);
  pdfService.drawWrappedText(
  ...
  // page.drawImage(roadmapImg, {
  //   x: 90,
  //   y: pdfService.setCurrentY( )160, // Adjust the image position
  //   width: columnWidth * 0.8, // Adjust the image width
  //   height: 150, // Adjust the image height
  // });
  pdfService.setCurrentY(15);
  ...
  // await pdfService.addLocalImage('./assets/low-level-arch.jpg');
  // pdfService.setCurrentY(3);
  // pdfService.drawWrappedText("This diagram illustrates the architecture of an LLM (Large Language Model) application, organized into three main categories: user input handling, input enrichment and prompt optimization, and efficient and responsible AI processing. It shows how data flows from initial input, through filtering, embedding, and prompt optimization, to aggregation and output generation, ensuring secure, optimized, and responsive outputs tailored to user queries.",'left');
  // // pdfService.setCurrentY(125);
  // pdfService.drawWrappedText(" ","left");
  // pdfService.setCurrentY(45);
  // pdfService.setCurrentY(10);
  ...
  pdfService.drawHeading("9. Conclusion", "left");
  pdfService.setCurrentY(5);
  pdfService.drawWrappedText(
